...
export default function Navbar() {
  ...
  const disableNav =
    "cursor-pointer hover:text-[#e2620c] py-[0.3rem] px-[0.7rem] sm:px-3  rounded-lg ";
  const enableNav =
    "cursor-pointer  py-[0.3rem] px-[0.7rem] sm:px-3  rounded-lg bg-[#ff3e17]/10 text-[#ff3e17]";

  return (
    <header className="">
      <nav className="w-full h-52 flex items-center justify-center mb-10">
        <ul className=" font-bold rounded-lg flex flex-wrap  sm:gap-3  bg-slate-300/50">
          <li 
