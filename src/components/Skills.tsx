    ...
    <>
      <div className="flex flex-col justify-center items-center gap-4">
        ...
        <p className="font-semibold text-center text-lg md:text-xl">
          ...
          <span className="font-bold text-[#8a51fb]">tools</span> that i usually
          use or have dealt with,
          <br />
          For more detailed info, please feel free to visit my{" "}
          <span className="font-bold text-[#8a51fb]">GitHub account.</span>
        </p>
      </div>

      <div className="w-full flex justify-center ">
        <div className="rounded-[32px] p-[32px] w-full lg:w-fit ">
          <div
            id="stackIcons"
          ...
          >
            ...
            >
              <div className="bg-gradient-to-br from-[#E34F26] to-[#e32642] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
              ...
              <div className="bg-gradient-to-br from-[#027fff] to-[#02afff] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
                  className="w-4 md:w-6 "
                  fill="#f5f5f7"
                  role="img"
              ...
              <div className="bg-gradient-to-br from-[#ffd902] to-[#ffea02] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
                  className="w-4 md:w-6"
                  fill="#1d1d1f"
                  role="img"
              ...
              <div className="bg-gradient-to-br from-[#02a2ff] to-[#02b7ff] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
                  className="w-4 md:w-6"
                  fill="#f5f5f7"
                  role="img"
            ...
            <div
              ...
              className="flex justify-center items-center gap-2"
            >
              <div className="bg-gradient-to-br from-[#c33d70] to-[#c33da4] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
                  className="w-4 md:w-6"
                  fill="#f5f5f7"
                  role="img"
              ...
              <div className="bg-gradient-to-br from-[#ab02ff] to-[#8502ff] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
                  className="w-4 md:w-6"
                  fill="#f5f5f7"
                  role="img"
              ...
              <div className="bg-gradient-to-br from-[#3d48c3] to-[#3d73c3] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
                  className="w-4 md:w-6"
                  fill="#f5f5f7"
                  role="img"
              ...
              <div className="bg-gradient-to-br from-[#3da8c3] to-[#3dafc3] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
                  className="w-4 md:w-6"
                  fill="#f5f5f7"
                  role="img"
            ...
            <div
              ...
              className="flex justify-center items-center gap-2"
            >
              <div className="bg-gradient-to-br from-[#02e1ff] to-[#02a2ff] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
                  className="w-4 md:w-6"
                  fill="#1d1d1f"
                  role="img"
              ...
              <div className="bg-gradient-to-br from-[#c33d96] to-[#c33dbf] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
                  className="w-4 md:w-6"
                  fill="#f5f5f7"
                  role="img"
            ...
            <div
              ...
              className="flex justify-center items-center gap-2"
            >
              <div className="bg-gradient-to-br from-[#c33d3d] to-[#c35c3d] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
                  className="w-4 md:w-6"
                  fill="#f5f5f7"
                  role="img"
              ...
              <div className="bg-gradient-to-br from-[#3d5ac3] to-[#3d89c3] flex justify-center items-center w-8 h-8 rounded-[10px] md:h-14  md:w-14 md:rounded-[20px]">
                <svg
                  className="w-4 md:w-6"
                  fill="#f5f5f7"
                  role="img"
