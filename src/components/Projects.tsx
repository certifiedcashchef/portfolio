export default function Projects() {
  return (
    <>
      ...
      Practical <span className="font-bold text-[#8a51fb] ">projects</span> and applications <br/> using the previously mentioned <span className="font-bold text-[#8a51fb] ">technologies</span>
      </p>
      ...
      >
        ...
        <div className="bg-[#8a51fb]/10  flex flex-col items-center justify-center w-[10rem] h-[8rem] p-4 gap-2 rounded-xl">
          <h1 className="font-black text-2xl leading-[1.2rem] text-center text-gray-700 bg-gradient-to-r from-[#8502ff] via-[#6302ff] to-[#ff8102] text-transparent bg-clip-text">
            NIKE <br /> STORE
          </h1>
          <p className="font-bold text-[0.57rem]">
          <a href="https://nike-ecommerce-clone.vercel.app/">LIVE DEMO</a>
 {" // "} <a href="https://github.com/certifiedcashchef/nike-ecommerce-clone">SOURCE CODE</a>
          </p>
        </div>
 ...
 {" // "} <a href="https://github.com/certifiedcashchef/plan-a2z">SOURCE CODE</a>
          </p>
        </div>
